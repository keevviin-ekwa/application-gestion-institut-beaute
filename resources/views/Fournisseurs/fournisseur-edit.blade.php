...
@section('content')
    ...
    <form action="{{url('admin/fournisseurs/update/'.$fournisseur->id)}}" method="POST">
        <div class="row">
        ...
        <div class="row">
            ...
            <x-adminlte-input name="adress" label="Adresse *" placeholder="placeholder"
                         value="{{$fournisseur->adress}}"     class="rounded-0 @error('adresse') border-danger @enderror"  fgroup-class="col-md-6 rounded-0" disable-feedback/>
        </div>
