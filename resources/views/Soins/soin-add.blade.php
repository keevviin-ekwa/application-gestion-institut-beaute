...
@section('content')
    ...
    <div class="row">
       <x-adminlte-input value="{{$edit->libelle ?? '   '}}" enable-old-support class="rounded-0" name="libelle" label="Libelle *" placeholder="Libelle..."
        ...
        <x-adminlte-select n data-title="Selectionner le type..." class="rounded-0"  fgroup-class="col-md-6" label="Type de Soin *" name="type">
    ...
    <div class="row">
        ...
        @endphp
        <x-adminlte-select2 style="height: 48px"  id="sel2Category" name="sel2Category[]" label="Produits"
